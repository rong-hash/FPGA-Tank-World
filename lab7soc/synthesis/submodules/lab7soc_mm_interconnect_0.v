...
module lab7soc_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [16:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> button_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                              // cmd_mux_011:src_valid -> hex_s1_agent:cp_valid
	wire  [107:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> hex_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // hex_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [16:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> hex_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                                      // cmd_mux_011:src_startofpacket -> hex_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                        // cmd_mux_011:src_endofpacket -> hex_s1_agent:cp_endofpacket
	...
	wire  [107:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_011:sink_data
	...
	wire          hex_s1_agent_rp_valid;                                                              // hex_s1_agent:rp_valid -> router_013:sink_valid
	wire  [107:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_013:sink_data
	wire          hex_s1_agent_rp_ready;                                                              // router_013:sink_ready -> hex_s1_agent:rp_ready
	wire          hex_s1_agent_rp_startofpacket;                                                      // hex_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          hex_s1_agent_rp_endofpacket;                                                        // hex_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [107:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> cmd_mux_012:sink1_data
	wire          cmd_demux_001_src5_ready;                                                           // cmd_mux_012:sink1_ready -> cmd_demux_001:src5_ready
	wire   [16:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> cmd_mux_012:sink1_channel
	...
	wire  [107:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_013:sink1_data
	wire          cmd_demux_001_src6_ready;                                                           // cmd_mux_013:sink1_ready -> cmd_demux_001:src6_ready
	wire   [16:0] cmd_demux_001_src6_channel;                                                         // cmd_demux_001:src6_channel -> cmd_mux_013:sink1_channel
	...
	wire  [107:0] cmd_demux_001_src8_data;                                                            // cmd_demux_001:src8_data -> cmd_mux_016:sink1_data
	...
	wire  [107:0] rsp_demux_012_src1_data;                                                            // rsp_demux_012:src1_data -> rsp_mux_001:sink5_data
	wire          rsp_demux_012_src1_ready;                                                           // rsp_mux_001:sink5_ready -> rsp_demux_012:src1_ready
	wire   [16:0] rsp_demux_012_src1_channel;                                                         // rsp_demux_012:src1_channel -> rsp_mux_001:sink5_channel
	...
	wire  [107:0] rsp_demux_013_src1_data;                                                            // rsp_demux_013:src1_data -> rsp_mux_001:sink6_data
	wire          rsp_demux_013_src1_ready;                                                           // rsp_mux_001:sink6_ready -> rsp_demux_013:src1_ready
	wire   [16:0] rsp_demux_013_src1_channel;                                                         // rsp_demux_013:src1_channel -> rsp_mux_001:sink6_channel
	...
	wire  [107:0] rsp_demux_016_src1_data;                                                            // rsp_demux_016:src1_data -> rsp_mux_001:sink8_data
	...
	wire          button_s1_agent_rdata_fifo_src_valid;                                               // button_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] button_s1_agent_rdata_fifo_src_data;                                                // button_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          button_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_009:in_0_ready -> button_s1_agent:rdata_fifo_src_ready
	...
	wire          hex_s1_agent_rdata_fifo_src_valid;                                                  // hex_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] hex_s1_agent_rdata_fifo_src_data;                                                   // hex_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          hex_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_011:in_0_ready -> hex_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                                  // avalon_st_adapter_011:out_0_valid -> hex_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                                   // avalon_st_adapter_011:out_0_data -> hex_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                                  // hex_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                                  // avalon_st_adapter_011:out_0_error -> hex_s1_agent:rdata_fifo_sink_error
	...
	lab7soc_mm_interconnect_0_router_009 router_009 (
	...
	lab7soc_mm_interconnect_0_router_004 router_014 (
	...
	lab7soc_mm_interconnect_0_router_004 router_018 (
	...
	lab7soc_mm_interconnect_0_cmd_mux_002 cmd_mux_007 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7soc_mm_interconnect_0_cmd_mux_002 cmd_mux_012 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7soc_mm_interconnect_0_cmd_mux_002 cmd_mux_016 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7soc_mm_interconnect_0_rsp_demux_002 rsp_demux_007 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	lab7soc_mm_interconnect_0_rsp_demux_002 rsp_demux_012 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7soc_mm_interconnect_0_rsp_demux_002 rsp_demux_016 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7soc_mm_interconnect_0_avalon_st_adapter_007 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
